...
public class TestHTMLDocument {
	...
	public void setup() {
		...
		testImage = new FileResource(3.0, 1024, "image", "/local/testImage.png", "name");
		testVideo = new FileResource(900.0, 4000, "video", "/local/testVideo.mp4", "name");
		testJavaScript = new FileResource(1.0, 2056, "script", "/local/testJS.js", "name");
		testCSS = new FileResource(1.0, 4096, "stylesheet", "/local/testCSS.css", "name");
		testMisc = new FileResource(2.0, 40, "misc", "/local/testMisc.zip", "name");
	}
